...
const createI18nContent = (t) => {
    const person = {
        ...
        location:  'Asia/Mumbai',        // Expecting the IANA time zone identifier, e.g., 'Europe/Vienna'
            ...
            institutions: [
                {
                    ...
                    description: <>{t(`about.studies.institutions.University of Mumbai.description`)}</>,
                },
                {
